...
- Added full-screen sub-agent details and recovery for unfinished workflow runs.
...
- Improved Maestro UCL, waiting-for-input state, taskbar badges, and sub-agent panel behavior.

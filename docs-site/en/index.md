...
- **Visual Config Management** — Graphical editors for Models, Auth, Settings, and global/project Maestro teammate task routing, plus Skill and Extension management.

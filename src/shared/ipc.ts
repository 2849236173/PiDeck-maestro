export const ipcChannels = {
	...
	configGetRaw: "config:get-raw",
	configGetTeammateModels: "config:get-teammate-models",
	configGetCompaction: "config:get-compaction",
	configGetMcp: "config:get-mcp",
	configGetModelFailover: "config:get-model-failover",
	configGetHooks: "config:get-hooks",
	configGetSkillConfig: "config:get-skill-config",
	configGetWebSearch: "config:get-web-search",
	configGetSmartSearch: "config:get-smart-search",
	configSaveModels: "config:save-models",
	configSaveAuth: "config:save-auth",
	configSaveSettings: "config:save-settings",
	configSaveTeammateModels: "config:save-teammate-models",
	configSaveCompaction: "config:save-compaction",
	configSaveMcp: "config:save-mcp",
	configSaveModelFailover: "config:save-model-failover",

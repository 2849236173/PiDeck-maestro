...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "config.maestroBundle.description": "Maestro 工作流与 teammate 多代理协作扩展组合，可一键安装缺失组件。",
  "config.maestroBundle.flowDescription": "提供 Maestro 工作流编排、计划与执行能力。",
  "config.maestroBundle.teammateDescription": "提供 teammate 多代理委派、模型路由与协作能力。",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "config.maestroBundle.description": "A Maestro workflow and teammate multi-agent bundle that installs any missing components in one step.",
  "config.maestroBundle.flowDescription": "Adds Maestro workflow orchestration, planning, and execution.",
  "config.maestroBundle.teammateDescription": "Adds teammate delegation, model routing, and multi-agent collaboration.",

...
const zhCN = {
  ...
  "app.thinkingPickerHint": "部分模型可能不支持全部档位；GPT 5.5/5.6 系列会提供 Fast，系统会自动调整为最接近的受支持档位",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "thinking.level.fast": "GPT 5.5/5.6 的快速推理模式；可在此手动开启或关闭",
  "thinking.levelLabel.fast": "Fast",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "app.thinkingPickerHint": "Some models may not support all levels. GPT 5.5/5.6 variants offer Fast; the system will use the closest supported level",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "thinking.levelLabel.minimal": "Minimal",
  "thinking.level.fast": "GPT 5.5/5.6 fast reasoning mode; enable or disable it manually here",
  "thinking.levelLabel.fast": "Fast",

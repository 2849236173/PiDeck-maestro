...
const zhCN = {
  ...
  "common.save": "保存",
  "vision.title": "视觉模型配置",
  "vision.description": "当前桌面端没有单独的 vision 配置编辑器。可在会话中执行 /vision，让 pi-maestro-flow 选择图像模型与 fallback；配置文件出现后可从源文件页编辑。",
  "vision.copyCommand": "复制 /vision",
  "vision.copied": "已复制 /vision，请粘贴到会话中执行",
  "vision.defaultFallback": "默认 fallback 模型",
  "vision.defaultFallbackHint": "缺省视觉模型无法识别图像时使用，含 image 输入的模型优先。",
  "vision.unsetProvider": "未设置默认 Provider",
  "vision.runInline": "在会话中执行",
  "vision.runInlineHint": "把 /vision 命令直接插入当前会话输入框。",
  "vision.runInlineNote": "flow 0.14 不持久化 vision 配置到 vision.json，仍依赖 /vision 命令内嵌 select 选项。",
  "vision.insertLabel": "要插入到输入框的命令",
  "vision.insertPlaceholder": "例如 /vision openai/gpt-4o",
  "vision.insertButton": "插入到输入框",
  "vision.inserted": "已写入当前会话输入框",
  "vision.candidates": "支持图像输入的模型",
  "vision.candidatesFilter": "搜索供应商或模型 ID",
  "vision.noImageModel": "当前 models.json 中没有声明支持 image 输入的模型。",
  "vision.appendDraft": "追加到命令草稿",
  "vision.sendAndExecute": "发送到会话",
  "vision.sendToSession": "发送到会话并执行",
  "vision.modelSent": "已发送到会话",
  "vision.selectHint": "点击模型名称直接发送到会话，或点击 + 追加到命令草稿",
  "vision.selected": "已选择",
...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "mcp.auth.description": "需要登录的 MCP 服务器请在当前会话中执行 /mcp-auth，Pi 会引导完成 OAuth 授权。",
  "mcp.auth.copyCommand": "复制 /mcp-auth",
  "mcp.auth.copied": "已复制 /mcp-auth，请粘贴到会话中执行",
  "modelFailover.title": "模型故障转移",
  "modelFailover.description": "配置主 Agent 的模型断路器与有序备用模型链，运行时由 pi-maestro-flow 扩展执行。",
  ...
  "hooks.description": "管理项目 .pi/hooks.json 与全局 hook-trust.json，运行时由 pi-maestro-flow 执行 Hook。",
  ...
  "webSearch.description": "管理 pi-maestro-flow 的 Web Search 提供商、路由、抓取安全策略和 Curator 工作流。搜索运行时仍由扩展执行。",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "vision.description": "The desktop UI does not yet expose a dedicated vision editor. Run /vision in the session to configure the image model and fallback; once a file exists, edit it from Raw Files.",
  ...
  "vision.defaultFallbackHint": "Used when the dedicated vision model cannot recognise the image; models with image input are preferred.",
  "vision.unsetProvider": "Default provider not set",
  "vision.runInline": "Run in session",
  "vision.runInlineHint": "Insert /vision directly into the current session input box.",
  "vision.runInlineNote": "flow 0.14 does not persist vision config to vision.json; /vision still uses the inline select prompt.",
  "vision.insertLabel": "Command to insert",
  ...
  "vision.candidates": "Models that accept image input",
  "vision.candidatesFilter": "Search provider or model id",
  "vision.noImageModel": "No models with image input declared in models.json.",
  ...
  "vision.selectHint": "Click model name to send directly, or click + to append to draft",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "mcp.auth.description": "For MCP servers that require login, run /mcp-auth in the current session to complete OAuth authorization.",
  ...
  "modelFailover.description": "Configure main-agent model circuit breaking and ordered fallback chains. Runtime switching is handled by pi-maestro-flow.",
  ...
  "hooks.description": "Manage project .pi/hooks.json and global hook-trust.json. pi-maestro-flow runs hooks at runtime.",
  ...
  "webSearch.description": "Manage pi-maestro-flow Web Search providers, routing, fetch safety policy, and the Curator workflow. The extension still owns search runtime execution.",

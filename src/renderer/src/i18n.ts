...
const zhCN = {
  ...
  "maestro.title": "Maestro 模型路由",
  "maestro.description": "配置 pi-maestro-flow 的 CLI 工具模型和角色路由。模型 ID 由各 CLI 解释，可直接填写任意有效值。",
  "maestro.scope": "配置作用域",
  "maestro.scope.global": "全局",
  "maestro.scope.workspace": "当前项目",
  "maestro.workspaceUnavailable": "当前没有可用的项目目录",
  "maestro.workspaceHint": "项目配置覆盖同名的全局工具和角色；未覆盖的项目继续继承全局配置。",
  "maestro.view": "Maestro 配置视图",
  "maestro.tools": "工具模型",
  "maestro.roles": "角色路由",
  "maestro.enabled": "启用",
  "maestro.primaryModel": "主模型",
  "maestro.secondaryModel": "备用模型",
  "maestro.reasoningEffort": "推理强度",
  "maestro.modelPlaceholder": "输入 CLI 模型 ID",
  "maestro.modelHint": "例如 glm-5.2、gpt-5.5 或 gemini-3.1-pro-preview；不会受 Pi 模型列表限制。",
  "maestro.optional": "可选",
  "maestro.inherited": "继承",
  "maestro.routingMode": "路由方式",
  "maestro.routingDirect": "固定工具",
  "maestro.routingFallback": "按顺序回退",
  "maestro.directTool": "指定工具",
  "maestro.fallbackChain": "Fallback 顺序",
  "maestro.addFallback": "添加候选工具",
  "maestro.selectTool": "选择工具",
  "maestro.moveUp": "上移",
  "maestro.moveDown": "下移",
  "maestro.removeTool": "移除工具",
  "maestro.restoreInherited": "恢复继承全局配置",
  "maestro.resolvedTool": "当前解析：{tool}",
  "maestro.none": "无可用工具",
  "maestro.noTools": "没有检测到 Maestro CLI 工具配置。请先运行 maestro config delegate reset 初始化 cli-tools.json。",
  "maestro.invalidConfig": "当前作用域的 cli-tools.json 无法解析",
  "maestro.invalidConfigHint": "为避免覆盖原内容，保存已禁用。请先修复 {path}。",
  "maestro.saved": "Maestro 路由配置已保存",
  "maestro.unsaved": "当前作用域有未保存的修改",
  "maestro.noChanges": "当前作用域没有修改",
  "maestro.effort.default": "使用工具默认值",
  "maestro.effort.low": "低",
  "maestro.effort.medium": "中",
  "maestro.effort.high": "高",
  "maestro.effort.max": "最高",
  "maestro.role.analyze": "分析",
  "maestro.role.explore": "探索",
  "maestro.role.review": "审查",
  "maestro.role.implement": "实现",
  "maestro.role.plan": "规划",
  "maestro.role.brainstorm": "头脑风暴",
  "maestro.role.research": "研究",
  "config.nav.trust": "信任",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "maestro.title": "Maestro Model Routing",
  "maestro.description": "Configure CLI tool models and role routing for pi-maestro-flow. Model IDs are interpreted by each CLI and can be entered freely.",
  ...
  "maestro.workspaceHint": "Project entries override global tools and roles with the same name; entries not overridden continue to inherit global configuration.",
  "maestro.view": "Maestro configuration view",
  "maestro.tools": "Tool Models",
  "maestro.roles": "Role Routing",
  "maestro.enabled": "Enabled",
  "maestro.primaryModel": "Primary model",
  "maestro.secondaryModel": "Secondary model",
  "maestro.reasoningEffort": "Reasoning effort",
  "maestro.modelPlaceholder": "Enter a CLI model ID",
  "maestro.modelHint": "For example glm-5.2, gpt-5.5, or gemini-3.1-pro-preview. This is not limited by Pi's model list.",
  "maestro.optional": "Optional",
  "maestro.inherited": "Inherited",
  "maestro.routingMode": "Routing mode",
  "maestro.routingDirect": "Direct tool",
  "maestro.routingFallback": "Ordered fallback",
  "maestro.directTool": "Selected tool",
  "maestro.fallbackChain": "Fallback order",
  "maestro.addFallback": "Add fallback tool",
  "maestro.selectTool": "Select a tool",
  "maestro.moveUp": "Move up",
  "maestro.moveDown": "Move down",
  "maestro.removeTool": "Remove tool",
  "maestro.restoreInherited": "Restore inherited global configuration",
  "maestro.resolvedTool": "Resolved now: {tool}",
  "maestro.none": "No enabled tool",
  "maestro.noTools": "No Maestro CLI tools are configured. Run maestro config delegate reset to initialize cli-tools.json.",
  "maestro.invalidConfig": "The cli-tools.json file for this scope cannot be parsed",
  "maestro.invalidConfigHint": "Saving is disabled to protect the original file. Fix {path} first.",
  "maestro.saved": "Maestro routing configuration saved",
  "maestro.unsaved": "This scope has unsaved changes",
  "maestro.noChanges": "No changes in this scope",
  "maestro.effort.default": "Use tool default",
  "maestro.effort.low": "Low",
  "maestro.effort.medium": "Medium",
  "maestro.effort.high": "High",
  "maestro.effort.max": "Max",
  "maestro.role.analyze": "Analyze",
  "maestro.role.explore": "Explore",
  "maestro.role.review": "Review",
  "maestro.role.implement": "Implement",
  "maestro.role.plan": "Plan",
  "maestro.role.brainstorm": "Brainstorm",
  "maestro.role.research": "Research",
